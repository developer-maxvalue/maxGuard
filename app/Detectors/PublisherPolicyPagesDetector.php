...
final class PublisherPolicyPagesDetector implements Detector
{
    ...
    private function inspectHomePageLinks(PageDocument $page): array
    {
        ...
        return [new DetectorResult(
            ...
            severity: 'high',
            confidence: 96,
            title: 'Thiếu liên kết đến các trang thông tin bắt buộc của nhà xuất bản',
            summary: 'Không tìm thấy từ trang chủ: '.implode(', ', $labels).'. Các trang này phải dễ truy cập để thể hiện danh tính, tính minh bạch, quyền riêng tư và trách nhiệm của nhà xuất bản.',
