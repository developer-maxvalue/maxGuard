            ...
            <div class="card mg-card">
                ...
                <div class="card-body pt-1">
                    <div class="row g-5">
                        ...
                        <div class="col-md-6"><label class="form-label">Thời gian chờ phản hồi</label><div class="input-group"><input class="form-control" type="number" name="timeout_seconds" min="5" max="3600" value="{{ old('timeout_seconds', $settings['timeout_seconds']) }}" required><span class="input-group-text">giây</span></div></div>
                    </div>
                </div>
            </div>
        </div>
